...
<div class="m-auto text-center my-5" style="max-width: 800px">
    ...
    <form method="post" action="/owners" class="g-3">
        @csrf
        ...
        <input type="text" name="name" class="form-control m-3" placeholder="Enter Restaurant Name">
        <input type="text" name="address" class="form-control m-3" id="googlePlacesAutocomplete" placeholder="Enter Restaurant Address">
